...
## Task 1
- Filename: `task1`
-  Description:the following code find the factorial of a number using a for loop where i have initialisez factorial of 0 and 1 as 1 and for any further number i have defined a variable fact as 1 and for i in range 1 to i+1 i have multiplied each number 
